...
(function() {
  var AddTitleCntl, DashCntl, EditEventCntl, ListCntl, NewEventCntl, SelectCntl, SettingsCntl, delay, mod, viewMod;
  ...
  viewMod.directive('pane', function() {
    return {
      ...
      controller: function($scope, $element) {
        return $scope.$on('selpane', function(ev, opts) {
